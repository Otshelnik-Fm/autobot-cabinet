...
* Появился вильтр <code>apply_filters( 'autobot_guest_text', $guest_text )</code> - если вам сообщение по умолчанию в ЛК автобота для гостя надо переназначить:
"Этот бот сможет рассылать вам новости сайта, подписки и уведомления.<br/>Войдите на сайт и проверьте его работу"
